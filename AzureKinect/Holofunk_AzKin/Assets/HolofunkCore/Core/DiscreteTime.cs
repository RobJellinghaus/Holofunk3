...
namespace Holofunk.Core
{
    ...
    public struct Time<TTime>
    {
        ...
        {
            return new Time<TTime>(Math.Min((long)first, (long)second));
        }

        public static Time<TTime> Max(Time<TTime> first, Time<TTime> second)
        {
            return new Time<TTime>(Math.Max((long)first, (long)second));
        }

        public static explicit operator long(Time<TTime> time)
        {
            return time._time;
        }
    ...
    public struct Duration<TTime>
    {
        ...
        {
            return new Duration<TTime>((long)value);
        }
